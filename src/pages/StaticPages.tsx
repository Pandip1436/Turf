...
export const TermsPage = () => (
  <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
    <div className="max-w-3xl mx-auto px-4">
      <h1 className="font-display text-5xl tracking-wider text-gray-900 dark:text-white mb-2">TERMS & CONDITIONS</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-8">Last updated: March 2026</p>
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-8 space-y-6 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
        {[
...
export const CancellationPage = () => (
  <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
    <div className="max-w-3xl mx-auto px-4">
      <h1 className="font-display text-5xl tracking-wider text-gray-900 dark:text-white mb-2">CANCELLATION POLICY</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-8">Please read our cancellation and refund policy carefully.</p>
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-8 space-y-6">
  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
    <div className="max-w-5xl mx-auto px-4">
      <div className="text-center mb-12">
        <h1 className="font-display text-5xl tracking-wider text-gray-900 dark:text-white mb-2">PRICING</h1>
        <p className="text-gray-500 dark:text-gray-400">Transparent rates. No hidden charges. Best value in Sivakasi.</p>
      </div>

      {/* Pricing cards */}
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-8 text-center">
          <div className="text-5xl mb-3">☀️</div>
          <h3 className="font-bold text-xl mb-1 dark:text-white">Day Time</h3>
          <p className="text-gray-400 text-sm mb-4">6:00 AM – 6:00 PM</p>
          <div className="mb-6">
            <span className="text-gray-400 line-through text-sm">₹800</span>
            <span className="font-display text-5xl text-gray-900 dark:text-white ml-2">₹600</span>
            <span className="text-gray-400">/hr</span>
          </div>
          <ul className="text-sm text-left space-y-2 mb-6 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-8 text-center">
          <div className="text-5xl mb-3">🏆</div>
          <h3 className="font-bold text-xl mb-1 dark:text-white">Tournament</h3>
          <p className="text-gray-400 text-sm mb-4">Sat 6 PM – Sun 3 AM</p>
          <div className="mb-6">
            <span className="text-gray-400 line-through text-sm">₹1500</span>
            <span className="font-display text-5xl text-gray-900 dark:text-white ml-2">₹1000</span>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-6">
        <h2 className="font-bold text-xl text-gray-900 dark:text-white mb-4 text-center">Multi-Hour Discounts</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-center">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-800">
                <th className="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-left">Duration</th>
                <th className="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Day (6AM-6PM)</th>
                <th className="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Night (6PM-6AM)</th>
                <th className="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300 text-green-600">Discount</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={d as string} className="border-t border-gray-100 dark:border-gray-700">
                  <td className="py-3 px-4 font-semibold text-left dark:text-gray-200">{d}</td>
                  <td className="py-3 px-4 text-gray-600 dark:text-gray-300">{day}</td>
                  <td className="py-3 px-4 text-gray-600 dark:text-gray-300">{night}</td>
  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
    <div className="max-w-3xl mx-auto px-4">
      ...
      <div className="flex items-center gap-4 mb-2">
        ...
        <h1 className="font-display text-5xl tracking-wider text-gray-900 dark:text-white">PRIVACY POLICY</h1>
      </div>
      <p className="text-gray-500 dark:text-gray-400 mb-2">Last updated: March 2026</p>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        {[
          ...
          <div key={b.label} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 text-center">
            <div className="text-2xl mb-1">{b.icon}</div>
            <div className="text-xs font-bold text-gray-900 dark:text-white">{b.label}</div>
            <div className="text-xs text-gray-400 mt-0.5">{b.sub}</div>
          </div>
        ))}
      </div>

      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-8 space-y-7 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">

        {/* 1 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">1. Information We Collect</h3>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={title as string} className="flex gap-3">
                ...
                <div><span className="font-semibold text-gray-800 dark:text-gray-200">{title}:</span> {desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* 2 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">2. How We Use Your Information</h3>
        ...
        {/* 3 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">3. How We Share Your Information</h3>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={party as string} className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
                <div className="font-semibold text-gray-800 dark:text-gray-200 mb-1">{party}</div>
                <div>{desc}</div>
              </div>
            ))}
          </div>
        ...
        {/* 4 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">4. Data Storage & Security</h3>
        ...
        {/* 5 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">5. Cookies & Local Storage</h3>
        ...
        {/* 6 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">6. Your Rights</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={right as string} className="border border-gray-200 dark:border-gray-700 rounded-xl p-3">
                <div className="font-semibold text-gray-800 dark:text-gray-200 text-xs mb-0.5">{right}</div>
        ...
        {/* 7 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">7. Data Retention</h3>
        ...
        {/* 8 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">8. Children's Privacy</h3>
        ...
        {/* 9 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">9. Third-Party Links</h3>
        ...
        {/* 10 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">10. Changes to This Policy</h3>
        ...
        {/* 11 */}
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-base">11. Governing Law</h3>
